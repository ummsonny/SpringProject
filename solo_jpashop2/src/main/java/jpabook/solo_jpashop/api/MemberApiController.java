...
public class MemberApiController {
    ...
    public CreateMemberResponse saveMemberV1(@RequestBody @Valid Member member) {
        //@RequestBody는 Member에 넘어온 데이터를 넣는다
        //@Valid는 member의 값을 검증한다. 만약 member안의 name위에 @NotEmpty가 있다면
        //값이 없을 경우 에러가 난다. --> 하지만 엔티티 자체로 데이터 받고 검증하는 건 안좋음
    ...
    static class CreateMemberRequest {
        @NotEmpty //엔티티말고 여기다가 valid(검증)조건 넣어라
        private String name;
    }
